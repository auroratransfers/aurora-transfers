...
const content = {
  hr: {
    ...
    welcome: { tag: "Dobrodošli", title: "Aurora Dubrovnik Transfers", p1: "Profesionalna smo agencija za privatne transfere koja putnicima pruža sigurnu, udobnu i pouzdanu uslugu prijevoza.", p2: "Naši iskusni vozači i moderna vozila brinu da svako putovanje bude ugodno, točno i bez stresa - bez obzira dolazite li poslovno ili turistički." },
  ...
  de: {
    ...
    welcome: { tag: "Willkommen", title: "Aurora Dubrovnik Transfers", p1: "Wir sind eine professionelle Agentur für sichere, komfortable und zuverlässige Privattransfers.", p2: "Erfahrene Fahrer und moderne Fahrzeuge sorgen für eine pünktliche und stressfreie Fahrt - geschäftlich oder privat." },
...
const interfaceContent = {
  hr: {
    ...
    homeLabel: "Početna stranica Aurora Dubrovnik Transfers", mainNavigation: "Glavna navigacija",
  ...
  en: {
    ...
    homeLabel: "Aurora Dubrovnik Transfers home", mainNavigation: "Main navigation",
  ...
  de: {
    ...
    homeLabel: "Startseite von Aurora Dubrovnik Transfers", mainNavigation: "Hauptnavigation",
  ...
  fr: {
    ...
    homeLabel: "Accueil de Aurora Dubrovnik Transfers", mainNavigation: "Navigation principale",
